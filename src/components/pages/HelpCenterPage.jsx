...
const faqs = [
  ...
  { category: 'Billing & Plans', icon: FiCreditCard, items: [
    { q: 'What plans are available?', a: 'We offer three plans: Starter ($99/mo, 1-5 technicians), Growth ($149/mo, 6-10 technicians), and Professional ($225/mo, 11-40 technicians). Every plan includes unlimited jobs — you are charged by team size, not by how much work you do.' },
