...
const faqs = [
  ...
  { category: 'Billing & Plans', icon: FiCreditCard, items: [
    { q: 'What plans are available?', a: 'We offer three plans: Starter ($99/mo, up to 10 technicians), Growth ($149/mo, up to 20 technicians), and Professional ($225/mo, up to 40 technicians). Every plan includes unlimited jobs — you are charged by team size, not by how much work you do.' },
